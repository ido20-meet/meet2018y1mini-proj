...
lines.write("POKEMON GO!", align='center', font = ("Impact",30,"normal"))
lines.penup()
lines.goto(0, 250)
lines.pendown()
lines.goto(400, 250)
...
food_pos = []
food_stamps = []
turtle.register_shape("pikatchu1.gif")
#Set up positions (x,y) of boxes that make up the snake
snake = turtle.clone()
snake.shape("pikatchu1.gif")
snake.pencolor("blue")
...
#############################################################################33
    if snake.pos() in pos_list[:-1]:
        snake_ind= pos_list.index(snake.pos())
         #What does this do?
        game_over.write("!!GAME OVER!!", align='center', font = ("Impact",100 ,"normal"))
        game_over.goto(0,-75)
        game_over.write("pikatchu dont eat pikatchu", align='center', font = ("Impact",50 ,"normal"))
        time.sleep(7)
        quit()
...
turtle.register_shape("pokeball.gif") #Add trash picture
                      # Make sure you have downloaded this shape 
                      # from the Google Drive folder and saved it
                      # in the same folder as this Python script

food = turtle.clone()
food.shape("pokeball.gif") 
